...
public class SpikeClusterCustomLayer extends CustomLayer {
    public SpikeClusterCustomLayer() {
     ...
     */
    static final String NAME = "Spike Cluster Layer";

    /**
     * Human-readable description of the plugin. This is used e.g. in the tooltip of the layer selection button.
     */
    static final String DESCRIPTION = "Layer that generates crystal clusters";
     ...
     */
    static final Color COLOUR = Color.PINK;
